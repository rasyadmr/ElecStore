    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto lg:py-5">
        ...
        <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div>
                    ...
                    <div>                        
                        ...
                        @enderror
                        "  placeholder="Layar: ...">{{ old('specification') }}</textarea>
                        @error('specification')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="flex flex-row items-center justify-center w-full">
                        ...
                        @enderror">
                            ...
                            <input id="dropzone-file" name="photo" id="photo" type="file" class="hidden" />
                            @error('photo')
                                <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                            @enderror
                        </label>
